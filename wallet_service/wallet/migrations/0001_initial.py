# Generated by Django 5.1 on 2025-10-31 01:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('FUND', 'FUND'), ('TRANSFER_OUT', 'TRANSFER_OUT'), ('TRANSFER_IN', 'TRANSFER_IN')], max_length=20)),
        ...
        migrations.AddIndex(
            model_name='wallet',
            index=models.Index(fields=['user_id'], name='wallet_wall_user_id_c5e6ee_idx'),
        ),
    ]
